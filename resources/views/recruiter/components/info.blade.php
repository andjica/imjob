...
<div class="card shadow-sm">
    <div class="card-header border-0 bg-light text-white d-flex justify-content-between align-items-center">
        ...
        <a href="{{ asset('/company/recruiter/edit') }}" title="Edit your profile" data-bs-toggle="tooltip"
            data-bs-placement="left"><i class="fas fa-pen-to-square fa-1x text-primary"
    ...
    <div class="card-body pt-9 pb-0 bg-white">
        ...
        <div class="d-flex flex-wrap flex-sm-nowrap">
            ...
            <div class="me-7 mb-4">
                @if (!empty($recruter->profile_image) && Storage::exists('public/' . $recruter->profile_image))
                    <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                        <img src="{{ asset('storage/' . $recruter->profile_image) }}"
                            alt="{{ $recruter->user->first_name }}" class="objfit">
                    </div>
                @else
            ...
            <div class="flex-grow-1">
                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                    ...
                    <div class="d-flex flex-column">
                        <div class="d-flex align-items-center mb-2">
                            <h2 class="text-gray-900 text-hover-primary fs-2 fw-bold me-1">
                                {{ $recruter->user->first_name }} {{ $recruter->user->last_name }}
                            </h2>
                        ...
                        {{-- <p class="text-muted fw-semibold">
                            ...
                            <strong>{{ $recruter->freelancerCompany->company->name }}</strong><br>
                            From {{ $recruter->freelancerCompany->company->country->name }}
                        </p> --}}
                    </div>
                    <!--end::Basic Info-->
                    ...
                    <div class="d-flex align-items-center w-200px w-sm-200px flex-column mt-3">
                        @if (isset($recruter->education) && !empty($recruter->education))
                            ...
                            <a href="{{ asset('/company/recruiter/view') }}"
                        ...
                        @else
                                        ...
                                        <li>
                                            {{-- @if (!empty($recruiter->education))
                                                <i class="fas fa-check-circle text-success me-2"
                                                    aria-hidden="true"></i>
                                            @else
                                                <i class="fas fa-times-circle text-danger me-2"
                                                    aria-hidden="true"></i>
                                            @endif --}}
                                            Profile Education
                                        </li>
                            ...
                            <div class="h-5px mx-3 w-100 bg-light mb-3">
                                {{-- <div class="bg-info rounded h-5px" role="progressbar"
                                    style="width: {{ $completionPercentage }}%;" aria-valuenow="50"
                                    aria-valuemin="0" aria-valuemax="100"></div> --}}
                            </div>
                            <a href="{{ asset('/company/recruiter/edit') }}"
                ...
                <div class="d-flex flex-wrap mb-4">
                    {{-- <div class="d-flex align-items-center me-5 mb-3">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <span
                                class="fw-bold">{{ $recruiter?->company?->category?->name ?? 'N/A' }}</span>
                        </div>
                    </div> --}}
                    {{-- <div class="d-flex align-items-center me-5 mb-3">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <span
                                class="fw-bold">{{ $recruiter?->company?->subCategory?->name ?? 'N/A' }}</span>
                        </div>
                    </div> --}}
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <span class="fw-bold">{{ $recruter->experience_level }}</span>
                        </div>
                    </div>
                </div>
                <!--end::Additional Info-->
                ...
                <ul class="nav nav-pills nav-pills-custom nav-pills-rounded mb-5">
                    ...
                    <li class="nav-item mb-3">
                        {{-- <a class="nav-link"
                            href="{{ asset('/company/recruiter/company/' . auth()->user()->company->id . '/details') }}">
