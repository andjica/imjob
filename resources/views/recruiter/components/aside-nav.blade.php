<div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside"
    ...
    <div class="aside-menu flex-column-fluid">
        ...
        <div class="hover-scroll-overlay-y my-2 py-2" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            data-kt-scroll-offset="0" style="height: auto !important">
            <!--begin::Menu-->
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                id="#kt_aside_menu" data-kt-menu="true">
                <div class="menu-item menu-accordion show {{ request()->route()->getName() && Str::startsWith(request()->route()->getName(), 'recruiter-dashboard') ? 'show' : '' }}"
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion show">
                        ...
                        <div class="menu-sub menu-sub-accordion">
                            ...
                            <div class="menu-item">
                                <a class="menu-link {{ Route::currentRouteName() === 'recruiter-active-jobs' ? 'active' : '' }}"
                                    href="{{ asset('recruiter/active/jobs') }}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                            ...
                            <div class="menu-item">
                                <a class="menu-link {{ Route::currentRouteName() === 'recruiter-inactive-jobs' ? 'active' : '' }}"
                                    href="{{ asset('recruiter/inactive/jobs') }}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                    ...
                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion show">
                        ...
                        <div class="menu-sub menu-sub-accordion">
                            <div class="menu-item">
                                <a class="menu-link {{ Route::currentRouteName() === 'recruiter-edit-recruiter' ? 'active' : '' }}"
                                    href="{{ asset('recruiter/edit') }}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                                    <span class="menu-title"><i class="fas fa-user text-muted fa-1x"></i> &nbsp;Edit
                                        recruiter</span>
                                </a>
                            </div>
                        </div>
                        <!-- <div class="menu-sub menu-sub-accordion">
                                <div class="menu-item">
                                <a class="menu-link {{ Route::currentRouteName() === 'recruiter-settings' ? 'active' : '' }}" href="{{ asset('/recruiter/settings') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                    ...
                    <div class="aside-footer flex-column-auto pt-5 pb-7 px-5" id="kt_aside_footer">
                        <a href="{{ asset('/recruiter/settings') }}" class="btn btn-custom btn-primary w-100"
