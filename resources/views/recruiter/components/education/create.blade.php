             ...
             <div class="card-body d-flex align-items-center bg-white">
                 <div class="w-100">
                     ...
                     <div class="d-flex justify-content-between align-items-center mb-2">
                         ...
                         <span class="fw-bold text-success" id="profileSuccessMessage" style="display: none;">Your
                             profile is fully completed! Save data!</span>
                     </div>
                     <!-- Progress Bar -->
                     <div class="progress" style="height: 10px;">
                         <div class="progress-bar bg-success" role="progressbar" style="width: 50%;" aria-valuenow="50"
                             aria-valuemin="0" aria-valuemax="100" id="profileProgressBar"></div>
                     </div>
                 </div>
             </div>
         </div>
     ...
     <div class="col-lg-10">
         ...
         <div class="card mb-5 mb-xl-10">
             ...
             <div class="card-body pt-3">
                 <form action="{{ route('recruiter-education-create') }}" method="POST"
                     id="recruiterEducationForm">
                     @csrf
                     <!-- School -->
                     <div class="row mb-5">
                         ...
                         <div class="col-lg-10">
                             <input type="text"
                                 class="form-control form-control-lg form-control-solid @error('school') is-invalid @enderror"
                             ...
                             <span class="text-danger" id="schoolEmpty">
                                 @error('school')
                                     {{ $message }}
                                 @enderror
                             </span>
                     ...
                     <div class="row mb-5">
                         ...
                         <div class="col-lg-10">
                             <input type="text" id="degree"
                                 class="form-control form-control-lg form-control-solid @error('degree') is-invalid @enderror"
                             ...
                             <span class="text-danger" id="degreeEmpty"> @error('degree')
                                     {{ $message }}
                                 @enderror
                             </span>
                         </div>
                     ...
                     <div class="row mb-5">
                         ...
                         <div class="col-lg-10">
                             <input type="text" id="fieldOfStudy"
                                 class="form-control form-control-lg form-control-solid @error('field_of_study') is-invalid @enderror"
                             ...
                             <span class="text-danger" id="fieldOfStudyEmpty">
                                 @error('fieldOfStudy')
                                     {{ $message }}
                                 @enderror
                             </span>
                     ...
                     <div class="row mb-5">
                         ...
                         <div class="col-lg-10">
                             <input type="number"
                                 class="form-control form-control-lg form-control-solid @error('year_of_graduation') is-invalid @enderror"
                                 name="yearOfGraduation" id="yearOfGraduation" placeholder="e.g., 2022"
                                 value="{{ old('year_of_graduation', $recruiterEducation->year_of_graduation ?? '') }}"
                                 min="1900" max="{{ now()->year }}" />
                             <div class="form-text">Specify the year you completed your studies.</div>

                             <span class="text-danger" id="yearOfGraduationEmpty"> @error('year_of_graduation')
                                     {{ $message }}
                                 @enderror
                             </span>
                     ...
                     <div class="row mb-5">
                         ...
                         <div class="col-lg-10">
                             ...
                             <div class="form-text">Optional: Add any additional information about your education (e.g.,
