        ...
        <div class="card-body px-4">
            <div class="navi navi-hover navi-active navi-link-rounded navi-bold">
                ...
                <div class="navi-item d-flex align-items-center justify-content-between py-3">
                    <a href="{{ asset('/recruiter/active/jobs') }}" 
                       class="d-flex align-items-center text-decoration-none {{ request()->is('recruiter/active/jobs') ? 'text-primary fw-bold' : 'text-muted text-hover-primary' }}">
                ...
                <!-- Inactive Jobs -->
                <div class="navi-item d-flex align-items-center justify-content-between py-3">
                    <a href="{{ asset('/recruiter/inactive/jobs') }}" 
                       class="d-flex align-items-center text-decoration-none {{ request()->is('recruiter/inactive/jobs') ? 'text-primary fw-bold' : 'text-muted text-hover-primary' }}">
                ...
                <!-- Create a New Job -->
                <div class="mt-4">
                    <a href="{{ asset('recruiter/job/create') }}" 
