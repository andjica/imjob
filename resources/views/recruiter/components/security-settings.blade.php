    ...
    <div class="col-lg-10">
        <div class="card mb-5 mb-xl-10">
            ...
            <div class="card-body pt-3">
                ...
                <!-- Email Update Form -->
                <form action="{{ route('user-email-update', $user->id) }}" method="POST" id="emailUpdateForm">
                    @csrf
                    @method('PUT')
                ...
                <form action="{{ route('user-password-update', $user->id) }}" method="POST" id="passwordChangeForm">
                    @csrf
                    @method('PUT')
