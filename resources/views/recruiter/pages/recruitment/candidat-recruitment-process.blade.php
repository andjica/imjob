...
@section('content')
    ...
    <div class="container m-0 pb-5">
        ...
        <a href="{{ asset('/recruiter/' . $jobId . '/recruitment-process') }}"
        ...
        @if ($candidate->recruitmentProcess->status != null)
            <div class="text-end mt-3 mb-0">
                <a href="{{ route('recruiter-recruitment-download.pdf', ['recruitment_process_id' => $candidate->recruitmentProcess->id]) }}"
        ...
        <div class="row process-overview mb-10 mt-3">
            <div class="col-12">
                @include('recruiter.components.recruitment.overview')
                @include('recruiter.components.recruitment.feedback-and-delete-modal')
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 mb-5">
                @include('recruiter.components.recruitment.schedule-meeting')
                @include('recruiter.components.recruitment.schedule-modal')

                @include('recruiter.components.recruitment.calendar-with-modal')
            </div>
        </div>
    </div>
