            ...
            <div class="col-12">
                ...
                <form action="" method="GET" class="d-flex">
                    <input type="text" name="query" class="form-control me-2"
                        placeholder="You can search job by Company name, Country name, City name, Category name, SubCategory name, national, international.."
                        value="{{ request('query') }}">
                        ...
                        <div class="card-body text-center">
                            <div class="alert alert-warning d-flex align-items-center p-5 mb-0">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <p class="mb-0">There are currently no active jobs in the system. Please <a
                                            href="{{ asset('/recruiter/job/create') }}">create a new job.</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        @foreach ($jobs as $job)
                            <div class="col-lg-5 col-md-6 mb-4">
                                <div class="card card-job">
                                    ...
                                    <a href="{{ asset('/recruiter/' . $job->id . '/recruitment-process') }}"
                                ...
                                <div class="modal fade" id="deleteJobModal{{ $job->id }}" tabindex="-1"
                                    aria-labelledby="deleteJobLabel{{ $job->id }}" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="deleteJobLabel{{ $job->id }}">Confirm
                                                    Delete</h5>
