    ...
    <div class="container m-0 pb-5">
        <div class="row">
            ...
            @else
                            ...
                            <form action="{{ route('store-job') }}" method="POST" id="jobForm">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 pe-10 border-end me-2">
                                        ...
                                        <div class="row mb-5">
                                            ...
                                            <input type="hidden" name="jobWorldType" id="jobWorldType"
                                                value="{{ old('jobWorldType', 'national') }}">
                                        </div>
                                        <!-- Job Title -->
                                        <div class="row mb-5">
                                        ...
                                        <!-- Salary Minimum -->
                                        <div class="row mb-5">
                                            <label class="col-lg-4 col-form-label fw-bold fs-6 required">Salary
                                                (Min):</label>
                                            <div class="col-lg-8">
                                                <input type="text"
                                                    class="form-control form-control-solid @error('salaryMin') is-invalid @enderror"
                                                    name="salaryMin" id="salaryMin" value="{{ old('salaryMin') }}" />
                                                <span class="text-danger" id="salaryMinEmpty">
                                                    @error('salaryMin')
                                                        {{ $message }}
                                                    @enderror
                                                </span>
                                        ...
                                        <div class="row mb-5">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text"
                                                    ...
                                                    name="salaryMax" id="salaryMax" value="{{ old('salaryMax') }}" />
                                            ...
                                            <div class="col-lg-8">
                                                <select name="experienceLevel" id="experienceLevel"
                                                    ...
                                                    @foreach (['Entry-Level', 'Mid-Level', 'Senior-Level', 'Managerial'] as $level)
                                                        <option value="{{ $level }}"
                                                            {{ old('experienceLevel') == $level ? 'selected' : '' }}>
                                                            {{ $level }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <div class="row mb-5">
                                            <label
                                                class="col-lg-4 col-form-label fw-bold fs-6 required">SubCategory:</label>
                                            <div class="col-lg-8">
                                            ...
                                            <div class="col-lg-8">
                                                <div id="skillsContainer">
                                                    <div class="input-group mb-2 skill-input-group">
                                                        <input type="text" class="form-control form-control-solid"
                                                            name="moreSkill[]" placeholder="Enter a skill" />
                                        ...
                                        <div class="row mb-5">
                                            <label class="col-lg-4 col-form-label fw-bold fs-6">Special
                                                Requirements:</label>
                                            <div class="col-lg-8">
                                        ...
                                        <div class="row mb-5 d-none" id="specialRequirementsFields">
                                            ...
                                            <div class="col-lg-8">
                                                <textarea class="form-control form-control-solid @error('special_requirements') is-invalid @enderror"
                                                    ...
                                                    placeholder="Enter any special requirements here...">{{ old('special_requirements') }}</textarea>
                                        ...
                                        <div class="row mb-5">
                                            ...
                                            <div class="col-lg-4">
                                                <input type="number"
                                                    ...
                                                    value="{{ old('min_age') }}" min="18" max="100" />
                                            ...
                                            <div class="col-lg-4">
                                                <input type="number"
                                                    ...
                                                    value="{{ old('max_age') }}" min="18" max="100" />
                                        ...
                                        <!-- Valid Until -->
                                        <div class="row mb-5">
                                            <label class="col-lg-4 col-form-label fw-bold fs-6 required">Valid
                                                Until:</label>
                                            <div class="col-lg-8">
                                                <input type="date"
                                                    class="form-control form-control-solid @error('validUntil') is-invalid @enderror"
                                                    name="validUntil" id="validUntil" value="{{ old('validUntil') }}" />
                ...
                @include('recruiter.components.job.create-modal-popup')
        </div>
        @endif
    </div>
@endsection
