                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="d-flex gap-3">
                                            ...
                                            <button type="button"
                                                ...
                                                name="jobWorldTypeButton" id="jobWorldTypeNational" value="national"
                                            ...
                                            <button type="button"
                                                class="btn btn-outline btn-light-primary fw-semibold fs-6 py-3 px-4"
                                                name="jobWorldTypeButton" id="jobWorldTypeInternational"
                                                value="international" onclick="setJobType('international')">
                                                <i class="fas fa-globe me-2"></i> International
                                            </button>
                                        </div>
                                        <!-- Hidden input to store the selected job type -->
                                        <input type="hidden" name="jobWorldType" id="jobWorldType"
                                            value="{{ old('jobWorldType', $job->job_world_type) }}">
>>>>>>> 7fa1911 (fix design and add find root)
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text"
                                                ...
                                                name="title" value="{{ old('title', $job->title) }}" id="title" />
                                            <span class="text-danger" id="titleEmpty">
                                                @error('title')
                                                    {{ $message }}
                                                @enderror
                                            </span>
                                    ...
                                    <!-- Job Description -->
                                    <div class="row mb-5">
                                        <label class="col-lg-4 col-form-label fw-bold fs-6 required">Job
                                            Description:</label>
                                        <div class="col-lg-8">
                                            <textarea class="form-control form-control-solid @error('description') is-invalid @enderror" name="description"
                                                rows="6" id="description"> {{ $job->description }}</textarea>
                               ...
                               <!-- SubCategory -->
                                <div class="row mb-5">
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text"
                                                class="form-control form-control-solid @error('salaryMax') is-invalid @enderror"
                                                name="salaryMax" value="{{ old('salaryMax', $job->salary_max) }}"
                                                id="salaryMax" />
                                            <span class="text-danger" id="salaryMaxEmpty">
                                                @error('salaryMax')
                                                    {{ $message }}
                                                @enderror
                                            </span>
...
>>>>>>> 7fa1911 (fix design and add find root)
                                    ...
                                    <!-- Experience Level -->
                                    <div class="row mb-5">
                                        <label class="col-lg-4 col-form-label fw-bold fs-6 required">Experience
                                            Level:</label>
                                        <div class="col-lg-8">
                                            <select name="experienceLevel" id="experienceLevel"
                                                ...
                                                <option value="{{ $job->experience_level }}">{{ $job->experience_level }}
                                                </option>
                                                ...
                                                @foreach ($experienceLevels as $level)
                                                    @if ($level !== $selectedExperience)
                                                        <!-- Ensures no duplicate option -->
                                                        <option value="{{ $level }}"
                                                            {{ $selectedExperience == $level ? 'selected' : '' }}>
                                                            {{ $level }}
                                                        </option>
                                                    @endif
                                                @endforeach
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-lg-8">
                                            <select name="categoryId" id="categoryId" data-control="select2"
                                                ...
                                                <option value="{{ $job->category->id }}">{{ $job->category->name }}
                                                </option>
                                            ...
                                            <span class="text-danger" id="categoryIdEmpty">
                                                @error('categoryId')
                                                    {{ $message }}
                                                @enderror
                                            </span>
...
=======
                                                <!-- Current Selected Option -->
                                                <option
                                                    value="{{ $job->subCategory->name === 'Other' ? 'Other' : $job->subCategory->id }}">
                                                    {{ $job->subCategory->name }}
                                                </option>
>>>>>>> 7fa1911 (fix design and add find root)
                                                ...
                                                @foreach ($subcategories as $subcat)
                                                    ...
                                                    @endif
                                                    <option
                                                        value="{{ $subcat->name === 'Other' ? 'Other' : $subcat->id }}">
                                                        {{ $subcat->name }}</option>
                                                @endforeach
                                            ...
                                            <span class="text-danger" id="subCategoryIdEmpty">
                                                @error('subCategoryId')
                                                    {{ $message }}
                                                @enderror
                                            </span>
                                    ...
                                    <div class="row mb-5 {{ $job->subCategory->name == 'Other' || $job->custom_subcategory ? '' : 'd-none' }}"
                                        id="otherSubRow">
                                        <label class="col-lg-4 col-form-label fw-bold fs-6 required">Other:</label>
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control form-control-solid"
                                                name="custom_subcategory" id="otherSub"
                                                value="{{ $job->custom_subcategory }}" />
                                            <span class="text-danger" id="otherCategoryEmpty">
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-lg-8">
                                            <select name="jobTypeId" id="jobTypeId" data-control="select2"
                                                class="form-control form-control-solid @error('jobTypeId') is-invalid @enderror">
                                                <option value="{{ $job->job_type_id }}"> {{ $job->jobType->name }}
                                                </option>
                                                @foreach ($jobTypes as $jobType)
                                                    <option value="{{ $jobType->id }}"
                                                        {{ old('jobTypeId') == $jobType->id ? 'selected' : '' }}>
                                                        {{ $jobType->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            <span class="text-danger" id="jobTypeIdEmpty">
                                                @error('jobTypeId')
                                                    {{ $message }}
                                                @enderror
                                            </span>
                                    ...
                                    <!-- Required Skills -->
                                    <div class="row mb-5">
                                        <label class="col-lg-4 col-form-label fw-bold fs-6 required">Required
                                            Skills:</label>
                                        <div class="col-lg-8">
                                            <input type="text"
                                                class="form-control form-control-solid @error('requiredSkills') is-invalid @enderror"
                                                id="requiredSkills" name="requiredSkills"
                                                value="{{ old('requiredSkills', $job->skills->first()->skill) }}" />
                                            <span class="text-danger" id="requiredSkillsEmpty">
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-lg-8">
                                            <div id="skillsContainer">
                                                @foreach ($job->skills as $index => $skill)
                                                    @if ($index > 0)
                                                        <!-- This skips the first skill -->
                                                        <div class="input-group mb-2 skill-input-group">
                                                            <input type="text" class="form-control form-control-solid"
                                                                name="moreSkill[]" value="{{ $skill->skill }}" />
                                                            <button class="btn btn-danger remove-skill-btn"
                                                                type="button">
                                                                <i class="fa fa-minus"></i>
                                                            </button>
                                                        </div>
                                        ...
                                        <div class="col-lg-8">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox"
                                                    id="has_special_requirements" name="has_special_requirements"
                                                    value="1"
                                            ...
                                            <span class="text-danger" id="specialRequirementsEmpty">
                                                @error('has_special_requirements')
                                                    {{ $message }}
                                                @enderror
                                            </span>
                                        </div>
                                    ...
                                    <div class="row mb-5 {{ $job->special_requirements ? '' : 'd-none' }}"
                                        id="specialRequirementsFields">
                                        <label for="special_requirements"
                                            class="col-lg-4 col-form-label fw-bold fs-6">Details:</label>
                                        <div class="col-lg-8">
                                            <textarea class="form-control form-control-solid @error('special_requirements') is-invalid @enderror"
                                                name="special_requirements" id="special_requirements" rows="4"
                                                placeholder="Enter any special requirements here...">{{ old('special_requirements', $job->special_requirements) }}</textarea>
                                    ...
                                    <!-- Age Range -->
                                    <div class="row mb-5">
                                        <label class="col-lg-4 col-form-label fw-bold fs-6 required">Age Range:</label>
                                        <div class="col-lg-4">
                                            <input type="number"
                                                class="form-control form-control-solid @error('min_age') is-invalid @enderror"
                                                name="min_age" id="min_age" placeholder="Min Age"
                                                value="{{ old('min_age', $job->min_age) }}" min="18"
                                                max="100" />
                                            <span class="text-danger" id="minAgeEmpty">
                                                @error('min_age')
                                                    {{ $message }}
                                                @enderror
                                            </span>
                                        ...
                                        <div class="col-lg-4">
                                            <input type="number"
                                                class="form-control form-control-solid @error('max_age') is-invalid @enderror"
                                                name="max_age" id="max_age" placeholder="Max Age"
                                                value="{{ old('max_age', $job->max_age) }}" min="18"
                                                max="100" />
                                            <span class="text-danger" id="maxAgeEmpty">
                                                @error('max_age')
                                                    {{ $message }}
                                                @enderror
                                            </span>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="date"
                                                class="form-control form-control-solid @error('validUntil') is-invalid @enderror"
                                                name="validUntil" id="validUntil" value="{{ $job->valid_until }}" />
                                            <span class="text-danger" id="validUntilEmpty">
                                                @error('validUntil')
                                                    {{ $message }}
                                                @enderror
                                            </span>
                                    ...
                                    <div class="spinner-border text-primary d-none" role="status" id="currencyLoading"
                                        style="position: absolute; top: 50%; left: 50%; z-index: 1000;">
                                        <span class="visually-hidden">Loading...</span>
                                    </div>
                                    <!-- Submit Button -->
