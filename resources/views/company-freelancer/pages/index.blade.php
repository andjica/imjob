            ...
            <div class="col-lg-10">
                ...
                <div class="card shadow-sm">
                    <div class="card-header border-0 bg-light text-white d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ asset('/company/freelancer/edit') }}" title="Edit your profile" data-bs-toggle="tooltip"
                            ...
                            <div class="me-7 mb-4">
                                @if (!empty($freelancer->profile_image) && Storage::exists('public/' . $freelancer->profile_image))
                                    <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                                        <img src="{{ asset('storage/' . $freelancer->profile_image) }}"
                                            alt="{{ $freelancer->user->first_name }}" class="objfit">
                                    </div>
                                @else
                            ...
                            <div class="flex-grow-1">
                                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <p class="text-muted fw-semibold">
                                            ...
                                            <strong>{{ $freelancer->freelancerCompany->company->name }}</strong><br>
                                    ...
                                    <div class="d-flex align-items-center w-200px w-sm-200px flex-column mt-3">
                                        @if (isset($freelancer->education) && !empty($freelancer->education))
                                            ...
                                            <a href="{{ asset('/company/freelancer/view') }}"
                                        ...
                                        @else
                                            ...
                                            <a href="{{ asset('/company/freelancer/edit') }}"
                                ...
                                <div class="d-flex flex-wrap mb-4">
                                    <div class="d-flex align-items-center me-5 mb-3">
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <span
                                                class="fw-bold">{{ $freelancer->freelancerCompany?->company?->category?->name ?? 'N/A' }}</span>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center me-5 mb-3">
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <span
                                                class="fw-bold">{{ $freelancer->freelancerCompany?->company?->subCategory?->name ?? 'N/A' }}</span>
                                        </div>
                                    </div>
                                ...
                                <div class="d-flex flex-wrap mb-4">
                                    ...
                                    <div class="d-flex align-items-center mb-3">
                                        ...
                                        <div class="d-flex flex-column">
                                            <span
                                                class="fs-2 fw-bold">{{ \Carbon\Carbon::parse($freelancer->birthday)->age }}
                                                years</span>
                                ...
                                <ul class="nav nav-pills nav-pills-custom nav-pills-rounded mb-5">
                                    ...
                                    <li class="nav-item mb-3">
                                        <a class="nav-link"
                                            href="{{ asset('/company/freelancer/company/' . auth()->user()->company->id . '/details') }}">
                                            <i class="fas fa-building me-2" aria-hidden="true"></i> Your Company Overview
                                        </a>
                                    </li>
                                    <li class="nav-item mb-3">
                                        <a class="nav-link" href="{{ asset('/company/freelancer/active/jobs') }}">
