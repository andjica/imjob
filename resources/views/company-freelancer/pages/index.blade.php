    ...
    <div class="row">
        <div class="col-lg-10">
            ...
            <div class="card-header border-0 bg-light text-white">
                    <h3 class="card-title">
                        <i class="fas fa-user me-2 text-white"></i> Freelancer Information
                    </h3>
                </div>
                                    ...
                                    @if(isset($freelancer->education) && !empty($freelancer->education))
                                        ...
                                        <div class="d-flex justify-content-between w-100 mb-2">
                                            <span class="fw-semibold fs-6 text-gray-500">
                                                <i class="fas fa-check-circle text-success me-2" aria-hidden="true"></i> Profile Completed
                                            </span>
                                        ...
                                        <a href="{{ asset('/company/freelancer/view') }}" class="btn btn-success btn-sm w-100">
