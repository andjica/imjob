...
<div class="container m-0 pb-5">
    ...
    <a href="{{asset('company/freelancer/'.$jobId.'/recruitment-process')}}" class="btn btn-sm bg-linear-pink text-white  p-2"> <i class="fa fa-chevron-left text-white"></i> Back</a>
