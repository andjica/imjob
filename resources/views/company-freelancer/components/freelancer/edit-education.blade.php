                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-lg-10">
                            <input type="text" class="form-control form-control-lg form-control-solid @error('school') is-invalid @enderror" 
                                ...
                                value="{{ old('school', $freelancer->education->school ?? '') }}" />
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-lg-10">
                            <input type="text" id="degree" class="form-control form-control-lg form-control-solid @error('degree') is-invalid @enderror" 
                                ...
                                value="{{ old('degree', $freelancer->education->degree ?? '') }}" />
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-lg-10">
                            <input type="text" id="fieldOfStudy" class="form-control form-control-lg form-control-solid @error('field_of_study') is-invalid @enderror" 
                                ...
                                value="{{ old('field_of_study', $freelancer->education->field_of_study ?? '') }}" />
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-lg-10">
                            <input type="number" class="form-control form-control-lg form-control-solid @error('year_of_graduation') is-invalid @enderror" 
                                ...
                                value="{{ old('year_of_graduation', $freelancer->education->year_of_graduation ?? '') }}" min="1900" max="{{ now()->year }}" />
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-lg-10">
                            <textarea class="form-control form-control-lg form-control-solid @error('description') is-invalid @enderror" 
                                name="description" id="description" rows="4" placeholder="Add any additional details about your education">{{ old('description', $freelancer->education->description ?? '') }}</textarea>
