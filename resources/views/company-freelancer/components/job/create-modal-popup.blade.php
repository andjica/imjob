    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row gx-9 gy-6">
            ...
            <div class="card card-dashed h-xl-100 p-6 d-flex flex-column justify-content-between">
              <div class="d-flex align-items-start">
                ...
                <div class="form-check me-4">
                  <input class="form-check-input" type="radio" name="selectedCompany" id="company{{ $company->id }}" value="{{ $company->id }}" required>
                </div>
          ...
          @endforeach
          @if(auth()->user()->recruiter->is_freelancer == 1)
          <div class="col-xl-6" data-kt-billing-element="card">
            <!-- Card with radio button -->
              ...
              <div class="d-flex align-items-start">
                ...
                <div class="d-flex flex-column">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div>
                      <div class="fs-4 fw-bold">{{ auth()->user()->company->category->name }}, {{ auth()->user()->company->subCategory->name }}</div>
                      <div class="fs-6 fw-semibold text-gray-500">{{ auth()->user()->company->country->name }}, {{ auth()->user()->company->city->name }}</div>
                    </div>
                  </div>
                </div>
              </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
       <div class="modal-body text-center">
        ...
        <div class="modal-footer">
          <a href="{{asset('/company/freelancer/find/companies')}}" class="btn btn-primary">View All Companies</a>
