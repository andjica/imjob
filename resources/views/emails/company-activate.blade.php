...
<body>
    ...
    <div class="email-container">
        ...
        <div class="email-body">
            <h3 class="text-primary">{{ $company->name }} your Account is active now!</h3>

            <img src="{{ asset('images/upgrade.svg') }}" alt="Active company" height="160" style="text-align: center;">
            <p>We have received your company registration, and your account is ready.</p>

            <p> Now, You are able to manage your activities and start using our platform.</p>
