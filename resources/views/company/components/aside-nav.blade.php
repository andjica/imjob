<div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">            <!--begin::Brand-->
            ...
            <div class="aside-menu flex-column-fluid">
                ...
                <div class="hover-scroll-overlay-y my-2 py-2" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0" style="">
                    ...
                    <div class="menu-item menu-accordion show {{ request()->route()->getName() && Str::startsWith(request()->route()->getName(), 'company-dashboard') ? 'show' : '' }}" data-kt-menu-trigger="click">
                        <div class="menu-item">
                        ...
                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion show">
                            ...
                            <div class="menu-sub menu-sub-accordion">
                                ...
                                <div class="menu-item">
                                    <a class="menu-link {{ request()->is('company/dashboard/job/create') ? 'active' : '' }}" href="{{ url('/company/dashboard/job/create') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                ...
                                <div class="menu-item">
                                    <a class="menu-link {{ Route::currentRouteName() === 'company-dashboard-active-jobs' ? 'active' : '' }}}" href="{{ url('/company/dashboard/active/jobs') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                ...
                                <div class="menu-item">
                                    <a class="menu-link {{ Route::currentRouteName() === 'company-inactive-jobs' ? 'active' : '' }}}" href="{{ url('/company/dashboard/inactive/jobs') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                         ...
                         <div data-kt-menu-trigger="click" class="menu-item menu-accordion show">
                                ...
                                <div class="menu-sub menu-sub-accordion">
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link {{ Route::currentRouteName() === 'edit' ? 'active' : '' }}" href="{{asset('company/dashboard/edit')}}">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                        ...
                        <div class="aside-footer flex-column-auto pt-5 pb-7 px-5" id="kt_aside_footer">
                            ...
                            <a href="{{asset('/company/dashboard/settings')}}" class="btn btn-custom btn-primary w-100" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss-="click" title="" data-bs-original-title="Make changes for your profile company">
