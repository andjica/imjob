...
@section('main-title', 'View Recuiter')
                                ...
                                <div class="d-flex flex-wrap mb-4">
                                    <div class="d-flex align-items-center me-5 mb-3">
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <span class="fw-bold">{{ $recruiter->category->name ?? 'N/A' }}</span>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center me-5 mb-3">
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <span class="fw-bold">{{ $recruiter->subCategory->name ?? 'N/A' }}</span>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center mb-3">
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <span class="fw-bold">{{ $recruiter->experience_level ?? 'N/A' }}</span>
                                        </div>
                                    </div>
                                </div>
                                <!--end::Additional Info-->
            ...
            <div class="col-lg-10">
                <div class="card shadow-sm">
                    <div class="card-header border-0 bg-light text-white">
                        <h3 class="card-title mb-0 d-flex align-items-center">
                            <i class="fas fa-user me-2 text-primary"></i>Personal Detail
                        </h3>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12 mb-7">
                                <label class="fw-semibold text-muted w-25">Full Name</label>
                                <span class="fw-bold fs-6 text-left text-gray-800">{{ $recruiter->user->first_name }}
                                    {{ $recruiter->user->last_name }}</span>
                            </div>
                            <div class="col-lg-12 mb-7">
                                <label class="fw-semibold text-muted w-25">Description</label>
                                <span
                                    class="fw-bold fs-6 text-gray-800">{{ $recruiter->category->description ?? 'N/A' }}</span>
                            </div>
                            <div class="col-lg-12 mb-7">
                                <label class="fw-semibold text-muted w-25">Country</label>
                                <span class="fw-bold fs-6 text-gray-800">{{ $recruiter->country->name ?? 'N/A' }}</span>
                            </div>
                            <div class="col-lg-12 mb-7">
                                <label class="fw-semibold text-muted w-25">City</label>
                                <span class="fw-bold fs-6 text-gray-800">{{ $recruiter->city->name ?? 'N/A' }}</span>
                            </div>
                            <div class="col-lg-12 mb-7">
                                <label class="fw-semibold text-muted w-25">Email</label>
                                <span class="fw-bold fs-6 text-gray-800">{{ $recruiter->user->email ?? 'N/A' }}</span>
                            </div>
                            <div class="col-lg-12 mb-7">
                                <label class="fw-semibold text-muted w-25">Phone</label>
                                <span class="fw-bold fs-6 text-gray-800">{{ $recruiter->phone_number ?? 'N/A' }}</span>
                            </div>
                        </div>
                    </div>
                </div>
