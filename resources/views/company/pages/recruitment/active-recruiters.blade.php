...
@section('main-title', 'Active Recruiters')

@section('title-dash', 'Here are your recruiters for recruitment process')
                ...
                <div class="card-body text-center">
                    <div class="alert alert-warning d-flex align-items-center p-5 mb-0">
                        ...
                        <div class="d-flex flex-column">
                            <h4 class="mb-1">No recruiter found yet!</h4>
                            <p class="mb-0">There are currently no connections. Please <a href="{{asset('/company/dashboard/find/recruiters')}}">follow a new recruiter.</a></p>
                        </div>
                    </div>
                </div>
            </div>
