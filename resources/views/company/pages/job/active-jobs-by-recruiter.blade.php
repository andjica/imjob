...
@section('main-title', 'Active Jobs by recruiter '.$recruiter->user->first_name.' '.$recruiter->user->last_name)

@section('title-dash', 'You have successfully delegated this job to the selected recruiter.')
