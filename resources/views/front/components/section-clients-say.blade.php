...
<div class="mt-20 mb-n20 position-relative z-index-2">
    ...
    <div class="container">
                ...
                <div class="d-flex flex-column justify-content-between h-lg-100 px-10 px-lg-0 pe-lg-10 mb-15 mb-lg-0">
                    ...
                    <div class="mb-7">
                        ...
                        <div class="text-gray-500 fw-semibold fs-4">
                            ...
                            The most well thought out design theme I have ever used. The codes are up to tandard. The
                            css styles are very clean.
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="symbol symbol-circle symbol-50px me-5">
                            <img src="{{ asset('images/user-profile.png') }}" class="" alt="profile">
                        </div>
                        <!--end::Avatar-->
        ...
        <div class="d-flex flex-stack flex-wrap flex-md-nowrap card-rounded shadow p-8 p-lg-12 mb-n5 mb-lg-n13"
            ...
            <!--begin::Link-->
            <a href="#" class="btn btn-lg btn-outline border-2 btn-outline-white flex-shrink-0 my-2">Purchase on
                Themeforest</a>
            <!--end::Link-->
        </div>
        <!--end::Highlight-->
