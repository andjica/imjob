                    ...
                    @else
                        ...
                        <div class="card card-flush" id="kt_contacts_list">
                            ...
                            <div class="card-header p-0" id="kt_contacts_list_header">
                                ...
                                @endif
                                <form action="{{ route('admin-dashboard-recruiters') }}" method="GET"
                                    ...
                                    <!--begin::Input-->
                                    <input type="text" id="searchRecruiter"
                                        class="form-control form-control-solid ps-13" name="search"
                                    ...
                                    <tbody>
                                        @forelse ($recruiters as $index => $recruiter)
                                            <tr class="text-center">
                                                ...
                                                <td class="text-start">
                                                    <span
                                                        class="d-block text-dark fw-semibold">{{ $recruiter->user->first_name }}</span>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                            <li><a class="dropdown-item"
                                                                    href="{{ route('admin-dashboard-recruiter-profile', $recruiter->id) }}">View
                                                                    Profile</a></li>
                                                            <!-- You can add more actions here -->
                                                            <li><a class="dropdown-item"
                                                                    href="{{ route('admin-dashboard-recruiter-profile', $recruiter->id) }}">Edit</a>
                                                            </li>
                                                            <li><a class="dropdown-item text-danger"
                                                                    href="{{ route('admin-dashboard-recruiter-profile', $recruiter->id) }}">Delete</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </td>
