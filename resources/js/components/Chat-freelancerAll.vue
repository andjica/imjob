                ...
                >
                    ...
                    <div v-if="messages.length === 0">
                        <p class="message-info">
                            ...
                            {{ chatPlaceholderName }} to begin your
                            collaboration. Introduce yourself, share your ideas,
                            or ask any questions to get things moving.
                        </p>
                    </div>
                </div>
...
export default {
    ...
    computed: {
        ...
        sortedCandidates() {
            return [...this.candidates].sort((a, b) => {
                const aUnread = this.unreadMap[a.user?.id] || 0;
                const bUnread = this.unreadMap[b.user?.id] || 0;

                // Ako jedan ima nepročitanih, a drugi nema, taj ide gore
                if (aUnread > 0 && bUnread === 0) return -1;
                if (bUnread > 0 && aUnread === 0) return 1;

                // Ako su isti unread, sortiraj po poslednjoj poruci
    ...
    methods: {
        ...
        updateUnreadTotal() {
            ...
            emitter.emit("update-freelancer-navbar-badge", this.unreadTotal);
        },
            ...
            .listen(".MessageSent", (payload) => {
                ...
                if (isRelevant) {
                    ...
                    if (message.user_id !== this.currentUserId) {
                        ...
                        emitter.emit(
                            "update-freelancer-navbar-badge",
                            this.unreadTotal
                        );
                    }
                }
