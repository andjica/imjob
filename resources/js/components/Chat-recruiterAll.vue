                    ...
                    <div class="scroll-y me-n5 pe-5 h-lg-auto" data-kt-scroll="true"
                        ...
                        <div class="d-flex d-flex__column">
                            <div class="gap-4 user-card__scroll">
                                <div v-for="candidate in sortedCandidates" class="d-flex align-items-center px-2 user-card"
                                    :class="[
                                        selectedUser &&
                            ...
                            <hr class="my-4" />
                            <div class="gap-4 user-card__scroll">
                                <div v-for="user in sortedContributors" class="d-flex flex-row align-items-center" :class="{
                                    'user-active':
                                        selectedContributor &&
...
export default {
    ...
    methods: {
        ...
        updateUnreadTotal() {
            this.unreadTotal = Object.values(this.unreadMap).reduce((sum, count) => sum + count, 0);
        ...
        restoreLastSelectedUser() {
            ...
            const contributor = this.contributorData.find((c) => c.user.id === parsed.id);
    ...
    async mounted() {
        ...
        Echo.private(`chat.${this.currentUserId}`)
            ...
            .listen(".MessageSent", (payload) => {
                ...
                const isRelevant =
                    message.user_id === activeUserId || message.receiver_id === activeUserId;
